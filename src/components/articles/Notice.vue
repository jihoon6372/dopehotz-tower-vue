        ...
        <div class="content">
            <ul class="board_list">
                <li v-for="article in notice" :key="article.id">
                    <router-link :to="{ name: 'notice-detail', params: {slug: article.slug} }"><h4>{{ article.title }}</h4></router-link>
                    <router-link :to="{ name: 'notice-detail', params: {slug: article.slug} }"><p>{{ article.content }}</p></router-link>
